...
# Integrar FileUpload e estrutura de arquivos no File Manager / Ingestão Plan

> Adicionar componente FileUpload em components/ui; Table (shadcn) se ausente; usar na Ingestão para list/grid de arquivos do Storage; garantir File Manager mostre estrutura (árvore já existe).
