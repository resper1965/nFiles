...
# Recomendações da avaliação — n.files Plan

> Unificar FileManagerContent/FileTreeSection; alinhar documentação (Projetos = regras/preview/renomear, File system = árvore); deprecar FileManagerContent.
